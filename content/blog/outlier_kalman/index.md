...
\[ d^2 = y^T S^{-1} y. \]
What's nice about the Mahalanobis distance is that \(d^2\) follows a \(\chi_n^2\) distribution,
...
there is less than a \(1\%\) probability of that measurement occurring.
...
but I'd hope that if you're reading this and designing mission-critical systems, you don't take advice from a blog in any case.
